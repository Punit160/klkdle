...
const PageHeader = ({ children, headerRight }) => {
    ...
    if (fileName === "ssl-amc" || fileName === "ssl") {
        fileName = "AMC documentation";
    }
    ...
    return (
        <div className="page-header">
            ...
            <div className="page-header-right ms-auto d-flex align-items-center">
